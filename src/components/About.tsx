    ...
    <div className='about'>
      <div className='about-container'>
        <div>
          <h1>소개 및 가치관</h1>
          <p>
            안녕하세요, 신입 프론트엔드 개발자를 희망하는 <span>박설민</span>
            입니다. 저는 팀원들과 협력하며 문제를 해결해 나가는 과정에서 새로운
            관점을 배우고 성장하는 것을 중요하게 여깁니다. 교내 팀 프로젝트를
            통해 협업과 소통의 중요성을 깊이 깨달았으며, 이러한 경험을
            실무에서도 적극적으로 발휘하고자 합니다.
          </p>
          <br />
          <p>
        ...
        <div>
          ...
          <p>
            ...
            강화하며, 더욱 전문적인 프론트엔드 개발자로 성장하고자 합니다. 이를
            통해 팀의 목표 달성에 실질적으로 기여하는 개발자가 되고 싶습니다.
            <br />
            <br />
            특히 학교 팀 프로젝트에서 얻은 리더십과 커뮤니케이션 스킬을
            바탕으로, 팀원 각자의 강점을 극대화하며 모두가 즐겁고 효율적으로
