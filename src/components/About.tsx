      ...
      <div className='about-container'>
        ...
        <div>
          ...
          <p>
            ...
            성장에 힘쓰고 있습니다. 새로운 기술과 도전에 열려 있으며, 이를 통해
            팀의 목표 달성에 기여하고자 합니다.
            <br />
            <br />
            학교에서의 팀 프로젝트 경험을 통해 리더십, 역할 분담, 그리고 원활한
            커뮤니케이션의 중요성을 깨달았습니다. 이를 바탕으로 팀원들의 강점을
            극대화하고, 모두가 함께 즐겁고 효율적으로 협력하며 안정적으로
            프로젝트를 완수하는 데 기여할 수 있는 팀원이 되기를 희망합니다.
          </p>
        </div>
      </div>
    </div>
